...
#asta era inainte:
#def __init__(self, test_model=os.path.join ( cfg.cur_dir, 'log/model_dump/res101/snapshot_350.ckpt' ), show_image=False):
#asta e modificat de mine:
#def __init__(self, test_model=os.path.join ( cfg.cur_dir, 'log/model_dump/res51/snapshot_350.ckpt' ), show_image=False):
#si asta la fel, dar cu rezolutie mai mica, ar trebui sa mearga mai prost:
#def __init__(self, test_model=os.path.join ( cfg.cur_dir, 'log/model_dump/res52/snapshot_350.ckpt' ), show_image=False):
...
if __name__ == '__main__':
    #in dets e o singura imagine si mai multe bbox-uri
